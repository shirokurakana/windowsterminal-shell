    ...
    [bool]$isPreview)
{
    ...
    if ($layout -eq "Default") {
        ...
        CreateMenuItem "Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\shell\MenuTerminalAdmin_$guid" "在 $name 中打开 (管理员)" $profileIcon $elevated $true   
        ...
        CreateMenuItem "Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\Background\shell\MenuTerminalAdmin_$guid" "在 $name 中打开 (管理员)" $profileIcon $elevated $true   
    }
}
    ...
    [bool]$includePreview)
{
    ...
    if ($layout -eq "Default") {
        ...
        New-ItemProperty -Path 'Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\shell\MenuTerminal' -Name 'MUIVerb' -PropertyType String -Value '在终端中打开' | Out-Null
        ...
        New-ItemProperty -Path 'Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\Background\shell\MenuTerminal' -Name 'MUIVerb' -PropertyType String -Value '在终端中打开' | Out-Null
        ...
        New-ItemProperty -Path 'Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\shell\MenuTerminalAdmin' -Name 'MUIVerb' -PropertyType String -Value '在终端中打开 (管理员)' | Out-Null
        ...
        New-ItemProperty -Path 'Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\Background\shell\MenuTerminalAdmin' -Name 'MUIVerb' -PropertyType String -Value '在终端中打开 (管理员)' | Out-Null
        ...
        CreateMenuItem "Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\shell\MenuTerminalMini" "在终端中打开" $icon $command $false
        CreateMenuItem "Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\shell\MenuTerminalAdminMini" "在终端中打开 (管理员)" $icon $elevated $true   
        CreateMenuItem "Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\Background\shell\MenuTerminalMini" "在终端中打开" $icon $command $false
        CreateMenuItem "Registry::HKEY_CURRENT_USER\SOFTWARE\Classes\Directory\Background\shell\MenuTerminalAdminMini" "在终端中打开 (管理员)" $icon $elevated $true   
        return
    }
